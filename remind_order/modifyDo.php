...
try {
    ...
    $ptmt = $db->prepare("SELECT COUNT(*) as rt FROM `ordering` WHERE passwd = PASSWORD(:passwd) AND uid = :id");
    ...
    $utmt = $db->prepare("UPDATE `ordering` SET subject=:subject, contents=:contents, name=:name, secure=:isSecure WHERE uid = :id");
